		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<%@ include file="/WEB-INF/views/admin/header/header.jsp"%>
				...
				<div class="container-fluid">
					...
					<h4 class="text-info text-center">공지게시판 작성</h4>
					<br>
					<div class="container" role="main">

						<form action="writeboard/write.do" method="post" enctype="multipart/form-data" >
	 					...
	 					<div class="form-check">
									<input class="form-check-input" type="radio"
										name="n_important" id="n_important1" value="1"> <label
										class="form-check-label"> 긴급공지
									</label> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <input
										class="form-check-input" type="radio" name="n_important"
										id="n_important2" value="2" checked> <label
				  ...
				  <div class="input-group mb-3">
					   <div class="filebox clearfix">
						...
						<div class="justify-content-center">
							...
							<button type="button" class="btn btn-sm btn-primary" onclick="location.href='noticeboard'" id="btnList">목록</button>
